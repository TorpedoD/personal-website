...
<Feedback
    ...
    marginBottom="16"
    description={<>
        Make sure you have updated the <InlineCode>content.tsx</InlineCode> file with your own information and the <InlineCode>baseURL</InlineCode> variable in the <InlineCode>once-ui.config.ts</InlineCode> file.
    </>}
/>
